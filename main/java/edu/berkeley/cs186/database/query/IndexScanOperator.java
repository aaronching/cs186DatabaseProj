...
public class IndexScanOperator extends QueryOperator {
  ...
  public int estimateIOCost() throws QueryPlanException {
    // TODO: implement me!
    try {
      TableStats stats = this.transaction.getStats(tableName);
      float rf = stats.getReductionFactor(columnIndex, predicate, value);
      return (int)Math.ceil((this.transaction.getNumRecords(tableName) + this.transaction.getNumIndexPages(tableName, columnName)) * rf);
