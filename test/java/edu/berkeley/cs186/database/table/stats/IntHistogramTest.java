...
public class IntHistogramTest {
  ...
  public void testCopyWithLessThanEqualsPredicate() {
    IntHistogram histogram = new IntHistogram();
    ...
    IntDataType value = new IntDataType(320);
    IntHistogram copyHistogram = histogram.copyWithPredicate(PredicateOperator.LESS_THAN_EQUALS,
            value);

    assertEquals(1, copyHistogram.getEntriesInRange(320, 321));
    assertEquals(321, copyHistogram.getEntriesInRange(0, 320));
    assertEquals(322, copyHistogram.getEntriesInRange(0, 500));
    assertEquals(250, copyHistogram.getNumDistinct());
  }

  @Test
  @Category(StudentTestP2.class)
  public void testComputeNotEqualsReductionFactor() {
    IntHistogram histogram = new IntHistogram();
