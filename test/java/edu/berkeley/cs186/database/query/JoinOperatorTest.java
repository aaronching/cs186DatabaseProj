...
public class JoinOperatorTest {
  ...
  public void testSimpleJoinBNLJMultiplePagesExtraBuffers() throws QueryPlanException, DatabaseException, IOException {
    TestSourceOperator sourceOperator = new TestSourceOperator(2000);
    File tempDir = tempFolder.newFolder("joinTest");
    Database.Transaction transaction = new Database(tempDir.getAbsolutePath(), 10).beginTransaction();
    JoinOperator joinOperator = new BNLJOperator(sourceOperator, sourceOperator, "int", "int", transaction);
  ...
  @Test
  @Category(StudentTestP2.class)
  public void testSimpleJoinBNLJMultiplePagesOneBuffer() throws QueryPlanException, DatabaseException, IOException {
    TestSourceOperator sourceOperator = new TestSourceOperator(2000);
    File tempDir = tempFolder.newFolder("joinTest");
    Database.Transaction transaction = new Database(tempDir.getAbsolutePath(), 3).beginTransaction();
    JoinOperator joinOperator = new BNLJOperator(sourceOperator, sourceOperator, "int", "int", transaction);
  ...
  @Test
  @Category(StudentTestP2.class)
  public void testEmptyOtherJoins() throws QueryPlanException, DatabaseException, IOException {
    TestSourceOperator leftSourceOperator = new TestSourceOperator();
    ...
    joinOperator = new BNLJOperator(leftSourceOperator, rightSourceOperator, "int", "int", transaction);
  ...
  @Test
  @Category(StudentTestP2.class)
  public void testSimpleJoinGHJManyBuffers() throws QueryPlanException, DatabaseException, IOException {
    TestSourceOperator sourceOperator = new TestSourceOperator(5000);
    File tempDir = tempFolder.newFolder("joinTest");
    Database.Transaction transaction = new Database(tempDir.getAbsolutePath(), 10).beginTransaction();
    JoinOperator joinOperator = new BNLJOperator(sourceOperator, sourceOperator, "int", "int", transaction);
    ...
    assertEquals(5000*5000, numRecords);
  }
}
